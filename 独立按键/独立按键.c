...
unsigned char TempData[8]={0x3f,0x3f,0x3f,0x3f,0x3f,0x3f,0x3f,0x3f}; //存储显示值的全局变量
unsigned char counters[8]={0,0,0,0,0,0,0};
/*------------------------------------------------
                   函数声明
------------------------------------------------*/
...
void main (void) {
	...
	while (1) {         //主循环
		...
		if(num) {
			...
			TempData[num] = dofly_DuanMa[counters[num]];
		}
	}
}
